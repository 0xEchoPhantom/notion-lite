    ...
    <div className="w-72 bg-[#FBFBFA] border-r border-gray-200/80 h-screen flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3">
        ...
        <button 
          ...
          disabled={creating}
          className="w-full flex items-center gap-3 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md border border-dashed border-gray-300 mb-3 disabled:opacity-50 transition-colors"
        >
