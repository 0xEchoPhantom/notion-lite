    ...
    <div className="w-72 bg-[#FBFBFA] dark:bg-gray-800 border-r border-gray-200/80 dark:border-gray-700 h-screen flex flex-col">
      ...
      <div className="flex-1 px-3">
        <div className="mb-4">
          <Link 
            href="/app" 
            className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors"
          >
        ...
        <div className="px-3 py-2">
          <h2 className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Recycle Bin</h2>
        </div>

        <div className="space-y-1">
          <div className="px-3 py-2 bg-gray-200/70 dark:bg-gray-700 rounded-md">
