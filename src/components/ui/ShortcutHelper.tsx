...
export const ShortcutHelper: React.FC<ShortcutHelperProps> = ({ className }) => {
  ...
  const shortcuts = [
    ...
    { key: 'Cmd/Ctrl + /', desc: 'Open block menu' },
    { key: 'Cmd/Ctrl + B', desc: 'Bold selected text' },
    { key: 'Cmd/Ctrl + I', desc: 'Italic selected text' },
    { key: 'Cmd/Ctrl + U', desc: 'Underline selected text' },
    { key: 'Cmd/Ctrl + E', desc: 'Inline code selected text' },
    { key: 'Cmd/Ctrl + Shift + S', desc: 'Strikethrough selected text' },
    { key: 'Cmd/Ctrl + Shift + 0', desc: 'Convert to paragraph' },
    { key: 'Cmd/Ctrl + Shift + 1', desc: 'Convert to heading 1' },
    { key: 'Cmd/Ctrl + Shift + 2', desc: 'Convert to heading 2' },
    { key: 'Cmd/Ctrl + Shift + 3', desc: 'Convert to heading 3' },
    ...
    { key: '# (space)', desc: 'Create heading 1' },
    { key: '## (space)', desc: 'Create heading 2' },
    { key: '### (space)', desc: 'Create heading 3' },
    { key: '> (space)', desc: 'Create quote block' },
    { key: '--- (space)', desc: 'Create divider' },
    { key: '↑/↓ arrows', desc: 'Navigate between blocks' },
    { key: 'Backspace (at start)', desc: 'Merge with previous block' },
  ];
