...
export function NotionEmbed({ url, className = '', onRemove }: NotionEmbedProps) {
  ...
  return (
    <div className={`notion-page-link group relative inline-flex ${className}`}>
      ...
      >
  <div className="flex items-center gap-2 px-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer">
          {/* Notion icon */}
